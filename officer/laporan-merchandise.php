      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='laporan-merchandise.php' class="btn btn-sm btn-success" > Refresh</a>
           </form>
          	</div><br />
                 <div class="print-area table-responsif" id="print-area-2">
	               ...
	               $query1="SELECT merchandise.*, peserta.* FROM  merchandise, peserta 
	               where merchandise.nik=peserta.nip AND(merchandise.tanggal between '$tglawal'
	               and '$tglakhir')";
                    ...
                    <table class="heading" style="width:100%;">
                      <tr>
                      <td> <center><p style="text-align:center; font-size: 18px; font-weight:bold;">LAPORAN PENGAMBILAN MERCHANDISE PESERTA RAKERNAS <?php echo "$tahun" ?></p></center></td>
                  ...
                  <!-- Keterangan source range date Data -->
                  <table>
                    <tr>
                      <!-- <td><td><p style="text-align:left; font-size: 12px; font-weight:bold;">Dari Tanggal : <php echo $_GET['tglawal']; ?> </p></td></td>
                      <td><td><p style="text-align:left; font-size: 12px; font-weight:bold;">Sampai Tanggal : <php echo $_GET['tglakhir']; ?> </p></td></td> -->
                      <td><td><p style="text-align:left; font-size: 12px; font-weight:bold;">Tanggal :&nbsp; <?php echo $tglawal;?> &nbsp; </p></td></td> 
                      <td><td><p style="text-align:left; font-size: 12px; font-weight:bold;"> s/d &nbsp; <?php echo $tglakhir ;?> </p></td></td>
                    </tr>
                  </table>
