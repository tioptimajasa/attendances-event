...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	if ( $jenis_file=="application/pdf" || $jenis_file=="application/ppt" || $jenis_file=="application/vnd.ms-powerpoint" 
	|| $jenis_file=="application/pptx" || $jenis_file=="application/vnd.openxmlformats-officedocument.presentationml.presentation"
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $materi_file)) {
			$sql="INSERT INTO materi_event (nama_event,judul_materi,materi_file) VALUES
            ('$nama_event','$judul_materi','$materi_file')";
			echo "$sql";
