<?php
 ...
 $nama_file='Merchandise-Event'; //Beri nama file PDF hasil.
...
<div id="wrapper">
    ...
    <table class="heading" style="width:100%;">
        <tr>
        <td> <center><p style="text-align:center; font-size: 18px; font-weight:bold;">LAPORAN MECHANDISE EVENT</p></center></td>
        </tr>
        <tr>
    ...
    <div id="content">
        ...
        <?php
            ...
            $query1="SELECT merchandise.*, karyawan.* FROM  merchandise, karyawan 
	               where merchandise.nik=karyawan.nik AND(merchandise.tanggal between '$kd'
	               and '$kode')";
