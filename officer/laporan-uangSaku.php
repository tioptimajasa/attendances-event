      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Laporan Uang Saku</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Laporan Pengambilan Uang Saku</h3>
                ...
                <div class="box-body">
                <div class="col-lg-12">
              <form action='laporan-uangSaku.php' method="POST">
            <div class="col-lg-3">
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='laporan-uangSaku.php' class="btn btn-sm btn-success" > Refresh</a>
           </form>
          	</div><br />
