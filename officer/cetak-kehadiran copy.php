...
$tahun = date('Y');
 ...
 $nama_file='Laporan Kehadiran Peserta Rakernas'; //Beri nama file PDF hasil.
    ...
    <div id="content">
        ...
        <?php
            ...
            $query1="SELECT kehadiran.*, peserta.* FROM  kehadiran, peserta 
	               where kehadiran.nik=peserta.nip AND(kehadiran.tanggal between '$kd'
	               and '$kode')";
...
$mpdf->Output($nama_file." ".$date_tahun."-".date("Y/m/d H:i:s").".pdf" ,'I');
