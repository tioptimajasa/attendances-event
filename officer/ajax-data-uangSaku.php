...
$sql = "SELECT uang_saku.no, uang_saku.tanggal, uang_saku.waktu, uang_saku.nik, uang_saku.event, uang_saku.status, peserta.nip, peserta.nama";
$sql.=" FROM uang_saku, peserta WHERE uang_saku.nik=peserta.nip";
$query=mysqli_query($conn, $sql) or die("ajax-data-uangSaku.php: get uangSaku");
...
if( !empty($requestData['search']['value']) ) {
	...
	$sql = "SELECT uang_saku.no, uang_saku.tanggal, uang_saku.waktu, uang_saku.nik, uang_saku.event, uang_saku.status, peserta.nip, peserta.nama";
	$sql.=" FROM uang_saku, peserta ";
	$sql.=" WHERE uang_saku.nik=peserta.nip ";    // $requestData['search']['value'] contains search parameter
	...
	$query=mysqli_query($conn, $sql) or die("ajax-data-uangSaku.php: get uangSaku"); // again run query with limit
