...
$hari = date("d-m-Y");
header("Content-Disposition: attachment; filename=data-uangSaku-peserta-rakernas-2023.xls");
   ...
   <?php
	...
	$sql = mysqli_query($koneksi, "SELECT uang_saku.tanggal, uang_saku.waktu, uang_saku.waktu, uang_saku.nik, uang_saku.event, uang_saku.status, karyawan.nik, karyawan.nama FROM uang_saku, karyawan WHERE uang_saku.nik=karyawan.nik");
	$no = 1;
