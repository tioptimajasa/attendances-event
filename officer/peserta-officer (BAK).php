...
<?php include "../global-templates/waktu-session.php"; ?>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Data Peserta Rakernas</h3>
    ...
    <tbody>
                ...
                <div class="box-footer clearfix no-border">
                  <a href="input-peserta-officer.php" class="btn btn-sm btn-default pull-right"><i class="fa fa-plus"></i> Tambah Peserta Rakernas</a>
                  </div>
              </div><!-- /.box -->
