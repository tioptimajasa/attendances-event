...
$sql = "SELECT merchandise.no, merchandise.tanggal, merchandise.nik, merchandise.event, merchandise.status, peserta.nip, peserta.nama";
$sql.=" FROM merchandise, peserta WHERE merchandise.nik=peserta.nip";
...
if( !empty($requestData['search']['value']) ) {
	...
	$sql = "SELECT merchandise.no, merchandise.tanggal, merchandise.nik, merchandise.event, merchandise.status, peserta.nip, peserta.nama";
	$sql.=" FROM merchandise, peserta ";
	$sql.=" WHERE merchandise.nik=peserta.nip ";    // $requestData['search']['value'] contains search parameter
