          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                <div class="col-lg-12">
              <form action='laporan-kehadiran.php' method="POST">
            <div class="col-lg-3">
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='laporan-kehadiran.php' class="btn btn-sm btn-success" > Refresh</a>
           </form>
