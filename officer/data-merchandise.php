...
<?php include "../global-templates/waktu-session.php"; ?>
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Data Merchandise</h3>
             ...
             if(isset($_GET['aksi']) == 'delete'){
				$id = $_GET['id'];
				$cek = mysqli_query($koneksi, "SELECT * FROM merchandise WHERE no='$id'");
				if(mysqli_num_rows($cek) == 0){
					echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data tidak ditemukan.</div>';
				}else{
					$delete = mysqli_query($koneksi, "DELETE FROM merchandise WHERE no='$id'");
					if($delete){
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='admin.php' class="btn btn-sm btn-success" >Refresh</i></a>
            ...
            <a href="merchandise_exportxls.php" class="btn btn-sm btn-success"><i class="fa fa-file"></i> Export Excel</a><br /><br />
    ...
    <tbody>
                ...
                <div class="box-footer clearfix no-border">
                  <!-- <a href="merchandise.php" class="btn btn-sm btn-default pull-right"><i class="fa fa-plus"></i> Tambah Karyawan</a> -->
                  </div>
              </div><!-- /.box -->
 ...
 <script>
        $(document).ready(function() {
				var dataTable = $('#lookup').DataTable( {
					...
					"serverSide": true,
					"ajax":{
						url :"ajax-data-merchandise.php", // json datasource
