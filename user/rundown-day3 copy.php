...
<div class="container">
  <ul class="nav nav-pills nav-justified">
    ...
    <li><a href="rundown-day1.php" ><h3>Hari ke-1<h3></a></li>
    <li><a href="rundown-day2.php"><h3>Hari ke-2<h3></a></li>
    <li class="active"><a href="rundown-day3.php"><h3>Hari ke-3</h3></a></li>
  </ul>
</div>
...
<h2> Day 3 <small> Rabu, 30 Maret 2022</h2>
        ...
        <!-- //Timeline Rundown -->
                        ...
                        <ul class="timeline">
                            ...
                            <li class="event" data-date="17:00 WIB - 19:00 WIB">
                                <h3>ISHOMA (120 Menit)</h3>
                                <!-- <p>Panitia</p> -->
                            </li>
                            <li class="event" data-date="19:00 WIB - 21:00 WIB">
                                <h3>Dinner (120 Menit)</h3>
                                <p>D'Colonel Chicken Farm Bogor (D'Colonel Resto)</p>
                                <p><a href="https://goo.gl/maps/wP4PkNsoccJmidDj9"><i class="fa fa-map"> Click go to Maps</i></a></p>
                            </li>
                        </ul>
