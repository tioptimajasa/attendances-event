...
<?php
			...
			if(isset($_POST['kode'])){
                $query_kehadiran = mysqli_query($koneksi, "SELECT * FROM merchandise");
...
<center><input style="width:650px; height:75px; font-size: 25px;" name="kode" class="form-control" placeholder="Masukan NIK lalu tekan Enter untuk ambil Merchandise" onchange="this.form.submit();" autofocus="on" autocomplete="off"/></center>
</form>
</div>
<div class="col-lg-12" style="margin-top: 40px;">
<a href="index-user.php" class="btn btn-md btn-warning" style="margin-bottom : 5px;"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a> 
<!-- <a href="merchandise_exportxls.php" class="btn btn-md btn-success" style="margin-bottom : 5px;"> <span class="glyphicon glyphicon-file"></span> Export Excel</a> -->
<?php
