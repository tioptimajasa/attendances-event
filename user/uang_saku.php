...
<center><input style="width:650px; height:75px; font-size: 25px;" name="kode" class="form-control" placeholder="Masukan NIK lalu tekan Enter untuk ambil Uang Saku" onchange="this.form.submit();" autofocus="on" autocomplete="off"/></center>
</form>
</div>
<div class="col-lg-12" style="margin-top: 40px;">
