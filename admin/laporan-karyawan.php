      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Laporan Karyawan</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Laporan Karyawan</h3>
                ...
                <div class="box-body">
                <div class="col-lg-12">
              <form action='laporan-karyawan.php' method="POST">
            <div class="col-lg-3">
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='laporan-karyawan.php' class="btn btn-sm btn-success" > Refresh</a>
           </form>
          	</div><br />
