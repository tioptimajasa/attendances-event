...
<?php include "../global-templates/waktu-session.php"; ?>
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
             ...
             if(isset($_GET['aksi']) == 'delete'){
				$id = $_GET['id'];
				$cek = mysqli_query($koneksi, "SELECT * FROM peserta WHERE nip='$id'");
				if(mysqli_num_rows($cek) == 0){
					echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data tidak ditemukan.</div>';
				}else{
					$delete = mysqli_query($koneksi, "DELETE FROM peserta WHERE nip='$id'");
					if($delete){
    ...
    <tbody>
                ...
                <div class="box-footer clearfix no-border">
                  <a href="input-peserta.php" class="btn btn-sm btn-default pull-right"><i class="fa fa-plus"></i> Tambah Peserta</a>
                  </div>
              </div><!-- /.box -->
 ...
 <script>
        $(document).ready(function() {
				var dataTable = $('#lookup').DataTable( {
					...
					"serverSide": true,
					"ajax":{
						url :"ajax-data-peserta.php", // json datasource
