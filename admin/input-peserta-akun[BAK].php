              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="insert-peserta-akun.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                      <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
	                              ...
	                              <a href="input-peserta-akun.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
                      </form>
                  </div>
