<?php
 ...
 $nama_file='rakernas-optimajasa-2022'; //Beri nama file PDF hasil.
...
<html>
<head>
    <title>Attendances Event Apps | www.optimajasa.co.id</title>
    <style>
        *
        {
            margin:0;
...
<div id="wrapper">
    ...
    <table class="heading" style="width:100%;">
        <tr>
        <td> <center><p style="text-align:center; font-size: 18px; font-weight:bold;">Rakernas PT PESONNA OPTIMA JASA 2022</p></center></td>
        </tr>
        <tr>
        <td> <center><p style="text-align:center; font-size: 14px; font-weight:bold;"><?php echo $_SESSION['nama_usaha']; ?></p></center></td>
        </tr>
    </table><br />
         <table>
         <tr>
    ...
    <div id="content">
        ...
        <?php
            ...
            <tr>
                ...
                <td style="width:55%;"><b>Nama</b></td>
                <td style="width:35%;"><b>Departement</b></td>
            ...
            <tr>
                ...
                <td style="width:55%;" class="mono">&nbsp;&nbsp;<b><?php echo $data1['nama']; ?></b></td>
                <td style="width:35%;" class="mono"><b><center><?php echo $data1['departemen']; ?></center></b></td>
               </tr>         
             <?php   
              } 
              ?>
