...
header("Content-Disposition: attachment; filename=data-karyawan.xls");
   ...
   <?php
	...
	$sql = mysqli_query($koneksi, "SELECT kehadiran.tanggal, kehadiran.nik, kehadiran.event, kehadiran.status, karyawan.nik, karyawan.nama FROM kehadiran, karyawan WHERE kehadiran.nik=karyawan.nik");
	$no = 1;
