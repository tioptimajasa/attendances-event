...
<div class="col-lg-12" style="margin-top: 40px;">
<a href="data-hadiah.php" class="btn btn-md btn-warning" style="margin-bottom : 5px;"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a> <a href="merchandise_exportxls.php" class="btn btn-md btn-success" style="margin-bottom : 5px;"> <span class="glyphicon glyphicon-file"></span> Export Excel</a>
<?php
...
//Scan OK
     let scanner = new Instascan.Scanner({ video: document.getElementById('preview') });
      ...
      scanner.addListener('scan', function(c){
          ...
          $( "#scan" ).trigger( "submit" ); //post automatis from form id
      });
