        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              ...
              <a href="index-admin.php"><i class="fa fa-circle text-success"></i> ONLINE <br /></a>
            </div>
          </div><br />
          ...
          <ul class="sidebar-menu">
            ...
            $tampil=mysqli_query($koneksi, "select * from karyawan order by nik desc");
             ...
             <li>
              <a href="#">
                <i class="fa fa-user"></i> <span>Peserta & Akun</span> <i class="fa fa-angle-left pull-right"></i>
                <small class="label pull-right bg-yellow"><?php echo $total; ?></small>
              </a>
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i> List Peserta & Akun</a></li>
                <li><a href="input-peserta-akun.php"><i class="fa fa-circle-o"></i> Input Peserta & Akun</a></li>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-barcode"></i> <span>Scan Barcode Absensi</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
