      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">List Data Uang Saku</li>
          </ol>
        </section>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Data Uang Saku</h3>
             ...
             if(isset($_GET['aksi']) == 'delete'){
				$id = $_GET['id'];
				$cek = mysqli_query($koneksi, "SELECT * FROM uang_saku WHERE no='$id'");
				if(mysqli_num_rows($cek) == 0){
					echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data tidak ditemukan.</div>';
				}else{
					$delete = mysqli_query($koneksi, "DELETE FROM uang_saku WHERE no='$id'");
					if($delete){
 ...
 <script>
        $(document).ready(function() {
				var dataTable = $('#lookup').DataTable( {
					...
					"serverSide": true,
					"ajax":{
						url :"ajax-data-uangSaku.php", // json datasource
