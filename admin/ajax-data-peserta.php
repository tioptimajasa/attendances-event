...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	// $nestedData[] = '<td><center>
	//                  <a href="cetak-qr-peserta.php?id='.$row['nip'].'"  data-toggle="tooltip" title="Cetak Kartu" class="btn btn-sm btn-success"> <i class="glyphicon glyphicon-print"></i> </a>
    //                  <a href="edit-peserta.php?id='.$row['nip'].'"  data-toggle="tooltip" title="Edit" class="btn btn-sm btn-primary"> <i class="glyphicon glyphicon-edit"></i> </a>
    //                  <a href="detail-peserta.php?id='.$row['nip'].'"  data-toggle="tooltip" title="Detail" class="btn btn-sm btn-info"> <i class="glyphicon glyphicon-info-sign"></i> </a>
	// 			     <a href="#"  data-toggle="tooltip" title="Delete" onclick="return confirm(\'Silahkan hubungi tim TI-POJ \')" class="btn btn-sm btn-danger"> <i class="glyphicon glyphicon-trash"> </i> </a>
	//                  </center></td>';		
	//// Function for level Admin Edit=True, Delete=True
	$nestedData[] = '<td><center>
	                 <a href="cetak-qr-peserta.php?id='.$row['nip'].'"  data-toggle="tooltip" title="Cetak Kartu" class="btn btn-sm btn-success"> <i class="glyphicon glyphicon-print"></i> </a>
                     <a href="edit-peserta.php?id='.$row['nip'].'"  data-toggle="tooltip" title="Edit" class="btn btn-sm btn-primary"> <i class="glyphicon glyphicon-edit"></i> </a>
                     <a href="detail-peserta.php?id='.$row['nip'].'"  data-toggle="tooltip" title="Detail" class="btn btn-sm btn-info"> <i class="glyphicon glyphicon-info-sign"></i> </a>
				     <a href="peserta.php?aksi=delete&id='.$row['nip'].'"  data-toggle="tooltip" title="Delete" onclick="return confirm(\'Anda yakin akan menghapus data Peserta= '.$row['nama'].' ?\')" class="btn btn-sm btn-danger"> <i class="glyphicon glyphicon-trash"> </i> </a>
	                 </center></td>';		
