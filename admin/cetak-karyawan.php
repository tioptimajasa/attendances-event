...
<div id="wrapper">
    ...
    <table class="heading" style="width:100%;">
        <tr>
        <td> <center><p style="text-align:center; font-size: 18px; font-weight:bold;">LAPORAN DATA KARYAWAN</p></center></td>
        </tr>
        <tr>
    ...
    <div id="content">
        ...
        <?php
            ...
            $no=0;
                    ...
                    { $no++; ?>
            <tr>
                <td style="width:15%;" class="mono"><b><center><?php echo $data1['nik']; ?></center></b></td>
                <td style="width:50%;" class="mono">&nbsp;&nbsp;<b><?php echo $data1['nama']; ?></b></td>
