...
(2, 'rizkids', 'd1d8f9188eb6d6fc410ba154adfd6fbc016c043b', 'Rizki D.S', 'Rakernas', 'admin', '../admin/gambar_admin/epployee.png'),
...
(67, 'user', '77886a1e559b68d65e4da22518b119212b8c0372', 'Tes User gambar', '', 'user', '../admin/gambar_admin/epployee.png');
...
('11111', 'TES', 'Administration', 0, '', 0),
('22222', 'TES22', 'BISNIS OUTSOURCING', 0, '', 0),
('3333', 'TES 32', 'Administration', 0, '', 0),
('9922', 'tes9922', 'DIVISI BISNIS RENTAL', 0, '', 0),
...
('P821900034', 'Andri Prayogo', 'DIVISI KEUANGAN & T.I', 12, 'Twin', 2127),
...
(188, 'K772107962', '2023-01-05', '17:05:38', 'Rakernas PT PESONNA OPTIMA JASA Tahun 2022', 'Hadir');
...
(17, 'Rakernas PT PESONNA OPTIMA JASA Tahun 2022', 'Undangan Rakernas 2022', '../admin/materi_event/GRN Skenario - Item Service.pdf');
...
--
ALTER TABLE `kehadiran`
  MODIFY `no` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=189;

--
-- AUTO_INCREMENT untuk tabel `materi_event`
--
ALTER TABLE `materi_event`
  MODIFY `materi_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
