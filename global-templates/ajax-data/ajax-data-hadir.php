...
$query=mysqli_query($conn, $sql) or die("ajax-data-hadir.php: get Hadir");
...
if( !empty($requestData['search']['value']) ) {
	...
	$query=mysqli_query($conn, $sql) or die("ajax-data-hadir.php: get Hadir"); // again run query with limit
